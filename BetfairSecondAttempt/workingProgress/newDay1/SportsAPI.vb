...
Module SportsAPI   'deals with JSON requests and responses for betting operations as opposed to account operations 
    ...
    Private Function SendSportsReq(ByVal jsonString As String)
        ...
        Try
            ...
            request.Headers.Add("X-Application: KEY") ' INSERT KEY HERE
    ...
    'Classes and fcuntion for listMarketCatalogue response
    ...
    Public Class MarketBookRunnerClass
        Public selectionId As Integer  'Wrong type was assigned to this variable previously causing error in json repsonse
        Public handicap As Double
        Public status As String
        Public adjustmentFactor As Double
        Public lastPriceTraded As Double
        Public totalMatched As Double
        Public removalDate As Date   'Wrong type was assigned to this variable previously causing error in json repsonse
        Public ex As New ex
    ...
    'Classes and Function for placeOrdersResponse 
    ...
    Public Class PlaceInstructionRep
        Public status As String
        Public instruction As New PlaceInstructionReports
        Public betId As String
    ...
    Function DeserializeReplaceOrdersReponse(ByVal jsonResponse As String)
